...
public class LibraryResource {
    ...
    @Transactional
    public List<Book> searchPhraseSlopBook(@org.jboss.resteasy.annotations.jaxrs.QueryParam String pattern,
                                        @QueryParam Optional<Integer> size) {
        return searchSession.search(Book.class)
                .where(f ->
                        pattern == null || pattern.trim().isEmpty() ?
    ...
    @Transactional
    public List<Book> searchBookExcept(@org.jboss.resteasy.annotations.jaxrs.QueryParam String pattern,
                                 @QueryParam Optional<Integer> size) {
        return searchSession.search(Book.class)
                .where(f ->
                        pattern == null || pattern.trim().isEmpty() ?
    ...
    @Transactional
    public List<Book> searchBookFuzzy(@org.jboss.resteasy.annotations.jaxrs.QueryParam String pattern,
                                       @QueryParam Optional<Integer> size) {
        return searchSession.search(Book.class)
                .where(f ->
                        pattern == null || pattern.trim().isEmpty() ?
